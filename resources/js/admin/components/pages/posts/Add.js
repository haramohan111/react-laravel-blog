...
class Add extends React.Component
{
    ...
    handleCkeditorChange(event) {
        this.props.handleFieldChange("content", event.editor.getData());
    }
                    ...
                    <div className="row">
                        <form method="post" role="form" onSubmit={this.handleSubmit}>
                            ...
                            <PostForm post={this.props.post.post} create_update_spinner={this.props.post.create_update_spinner}
                                      ...
                                      handleFieldChange={this.handleFieldChange} handleCkeditorChange={(event, editor) => this.handleCkeditorChange(event)}
